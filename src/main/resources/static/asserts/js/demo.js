...
function addFunctionAlty(value, row, index) {
    return [
        '<button id="bind" type="button" class="btn btn-default" font-size=10px>图形化</button>'
    ].join('');
}
window.operateEvents = {
    'click #bind': function (e, value, row, index) {

        window.location.href='/data/USAmodel?code='+row.code;
    }
};
$('#exampleTable').bootstrapTable({
    url : "/page/USA", // 请求的后台URL（*）
