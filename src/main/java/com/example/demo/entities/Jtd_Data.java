...
@Data
@Document("jijin_data")
public class Jtd_Data implements Serializable {
    ...
    public Jtd_Data(ObjectId _id, String date, String code, String fundName, Double unitNetWorth, Double cumulativeNetWorth, Double growthRate) {
        this._id = _id;
        this.date = date;
        this.code = code;
